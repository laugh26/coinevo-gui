...
Text {
    ...
    CoinevoEffects.ColorTransition {
        ...
        targetObj: root
        duration: 750
        blackColor: root.themeTransitionBlackColor !== "" ? root.themeTransitionBlackColor : CoinevoComponents.Style._b_defaultFontColor
        whiteColor: root.themeTransitionWhiteColor !== "" ? root.themeTransitionWhiteColor : CoinevoComponents.Style._w_defaultFontColor
    }
}
