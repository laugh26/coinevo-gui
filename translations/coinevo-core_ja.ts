...
<context>
    ...
    <message>
        ...
        <translation>coinevoを送ったり受け取ったりするのが簡単になり、アドレスを手で打ち間違えるのを避けられます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>警告: キーの再利用に関する対策が組み込まれていない限り、coinevoのキーを別のフォークで使い回さないでください。あなたのプライバシーが損なわれます。</translation>
    </message>
    <message>
        ...
        <translation>警告: シードをクリップボードにコピーすると、シードを記録しcoinevoを盗む悪意あるソフトウェアに晒される可能性があります。シードは手で書き留めてください。</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some coinevo. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>自分のコンピュータでマイニングをすることでcoinevoネットワークをより強固にできます。多くの人がマイニングをすればするほど、攻撃はより難しくなります。

マイニングをするとcoinevoが手に入ることがあります。コンピュータはブロックの解となるハッシュ値を生成し、もしブロックを見つけたら報酬が手に入ります。グッドラック！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>組み込まれているcoinevoのバージョン: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>サードパーティーのサーバを使ってcoinevoネットワークに接続します。セキュリティは低くなりますがより簡単です。</translation>
    </message>
    <message>
        ...
        <translation>リモートノードを見つけるには、お好きな検索エンジンで&apos;coinevo remote node&apos;と検索してください。ノードが信頼できるサードパーティーによって運営されていることを確認してください。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このページでは共有リングデータベースを操作できます。このデータベースはcoinevoウォレットおよびcoinevoのキーを再利用するcoinevoクローンのウォレットで利用するためのものです。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>第三者がリング内に既知の使用済みインプットを見つけられないことは、coinevoトランザクションのどのインプットが使用されたのかを隠すために必要です。もし見つけられるとリング署名による保護は弱まります。もし1つのインプットを除いてすべてが使用済みだと知られている場合、実際に使用されたインプットは明らかとなり、coinevoが使っている3つの主要なプライバシー保護レイヤーのうちの1つであるリング署名の効果が失われてしまいます。&lt;br&gt;トランザクションでそれらのインプットを避けるため、既知の使用済みインプットのリストを用いてそれらを新規のトランザクションで使用しないようにできます。このようなリストはcoinevoプロジェクトによって保守されcoinevo.techのウェブサイトで公開されており、ここではこのリストをインポートすることができます。&lt;br&gt;あるいはcoinevo-blockchain-mark-spent-outputsというツールを使い、coinevoのブロックチェーン(およびキーを再利用するcoinevoクローンのブロックチェン)を自分でスキャンして既知の使用済みアウトプットのリストを生成できます。&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>coinevoのリング署名による保護を無効化しないため、あるアウトプットを使う際に異なるブロックチェーンで異なるリングを使うことは避けなければなりません。これは通常問題になりませんが、キーを再利用するcoinevoクローンが既存のアウトプットの使用を許している場合問題になります。この場合、既存のアウトプットは両方のチェーンで同じリングを使わなくてはなりません。&lt;br&gt;これはキーを再利用するソフトウェアが積極的にプライバシーを侵害しようとしない限り自動的に行われます。&lt;br&gt;もしキーを再利用するcoinevoクローンを使っていてそのクローンがこの保護を含んでいない場合も、まずクローンの方でアウトプットを使用しその後リングをこのページに手動で追加することで、トランザクションは保護されcoinevoを安全に使用できるようになります。&lt;br&gt;これらの機能を提供しないキーを再利用するcoinevoクローンを使用していない場合、すべては自動化されているので何もする必要はありません。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>キーを再利用するチェーンでアウトプットに使用されたリングを記録し、プライバシーの問題を避けるためcoinevoでも同じリングを使うようにします。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>coinevoアドレス (例: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>coinevoの送金に成功しました</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>coinevoネットワークとやりとりするにはウォレットをcoinevoノードに接続する必要があります。プライバシーのためにはあなた自身がノードを走らせることを推奨します。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>coinevoをすぐに使いたい場合ブートストラップノードを指定できます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>もしcoinevoを使うのが初めてならこのオプションを選んでください。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ハードウェアウォレットを接続して新しいcoinevoウォレットを作成。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>coinevo GUIの言語を変更。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>coinevoをもうすぐ使いに初めにリモートノードの利用はいいですがリモートノードの使う時に他の人はアドレスを追跡し、復元を開始するブロック高を洞察し、不正確な情報を送信することで、あなたの取引の詳細をもっと洞察できますよ。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このモードは少額のcoinevoを扱う場合に適しています。取引を作成したり管理したりする基本的な機能にアクセスできます。coinevoネットワークに自動的に接続するためcoinevoをすぐに使い始めることができます。</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>coinevoネットワークとやりとりするためウォレットはcoinevoノードに接続する必要があります。プライバシーのため自分自身でノードを走らせることを推奨します。
...
金額: </translation>
    ...
    <message>
        ...
        <translation>このアドレスは%1EVOを受け取りましたが、取引はまだ承認されていません</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1047"/>
        <source>This address received %1 coinevo, with %2 confirmation(s).</source>
        <translation>このアドレスは%1EVOを受け取り、その取引は%2回承認されました。</translation>
    </message>
    <message>
...
入力する必要があるでしょう。</translation>
    ...
    <message>
        ...
        <translation>coinevoの送金に成功しました: %1 トランザクション</translation>
    </message>
    <message>
