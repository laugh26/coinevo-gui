...
UninstallDisplayIcon={app}\coinevoo-wallet-gui.exe
...
; As of version 0.15.0.0, the coinevo .exe files do not carry version info anyway in their .exe headers.
...
begin
  ...
  s := 'The default folder to store the Coinevoo blockchain is ' + blockChainDefaultDir;
  ...
  RegQueryStringValue(HKEY_CURRENT_USER, 'Software\coinevo-project\coinevo-core', 'blockchainDataDir', blockChainDir);
...
Root: HKCU; Subkey: "Software\coinevot"; Flags: uninsdeletekeyifempty
Root: HKCU; Subkey: "Software\coinevo\coinevo-core"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\coinevo\coinevo-core"; ValueType: string; ValueName: "blockchainDataDir"; ValueData: {code:BlockChainDirOrEmpty};
